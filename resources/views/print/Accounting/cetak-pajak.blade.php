...
<head>
    ...
    <title>Cetak Pajak {{ $pajak->kode_pajak }}</title>
                    ...
                    <div class="card-header border-bottom-0 bg-gradient-light-to-secondary text-white-50">
                        <div class="row justify-content-between align-items-center mt-2 ">
                            ...
                            <div class="col-5 text-right">
                                <!-- Invoice details-->
                                <div class="h3 text-primary">Pembayaran Pajak</div>
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-6 text-lg-left" style="line-height: 1rem">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label class="small font-weight-500">: {{ $pajak->Jenistransaksi->nama_transaksi }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label class="small">: Rp.{{ number_format($pajak->total_pajak,2,',','.') }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                            ...
                                            <table class="hover" id="example" width="100%"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="text-center" style="width: 150px;">Data Pajak</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-center">{{ $detail->data_pajak }}</td>
                                                        <td class="text-center">{{ $detail->keterangan_pajak }}</td>
                                                        <td class="text-center">Rp.{{ number_format($detail->nilai_pajak,2,',','.') }}</td>
                                                    </tr>
