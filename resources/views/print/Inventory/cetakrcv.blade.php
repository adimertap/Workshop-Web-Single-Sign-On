...
<head>
    ...
    <title>Cetak Receiving {{ $rcv->kode_rcv }}</title>
                    ...
                    <div class="card-header border-bottom-0 bg-gradient-light-to-secondary text-white-50">
                        <div class="row justify-content-between align-items-center mt-2 ">
                            ...
                            <div class="col-5 text-right">
                                <!-- Invoice details-->
                                <div class="h3 text-primary">Receiving</div>
                                <span class="text-dark">{{ $rcv->kode_rcv }}</span>
                                <br>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-6 text-lg-left" style="line-height: 1rem">
                                <label class="small font-weight-700">Dari: </label>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col">
                                        <label class="small font-weight-500">: {{ $rcv->Supplier->nama_supplier }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col">
                                        <label class="small">: {{ $rcv->Supplier->telephone }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col">
                                        <label class="small">: {{ $rcv->Supplier->email }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col">
                                        <label class="small">: {{ $rcv->Supplier->alamat_supplier }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="font-weight-bold">
                                            <label class="small"> Nomor DO </label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label class="small">: {{ $rcv->no_do }} </label> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 text-lg-left" style="line-height: 1rem">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="font-weight-bold">
                                            <label class="small">Kode RCV </label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label class="small">: {{ $rcv->kode_rcv }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col">
                                        <label class="small">: {{ $rcv->Pegawai->nama_pegawai }} </label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="font-weight-bold">
                                            <label class="small"> Tanggal RCV </label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label class="small">: {{ $rcv->tanggal_rcv }} </label> 
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col">
                                        <label class="small">: {{ $rcv->PO->kode_po }} </label> 
                                    </div>
                                </div>
                                            ...
                                            <table class="hover" id="example" width="100%"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="text-center" style="width: 100px;">Sparepart</th>
                                                        ...
                                                        <th class="text-center" style="width: 70px;">Keterangan</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-center">Rp.{{ number_format($detail->pivot->harga_diterima,2,',','.')}}</td>
                                                    ...
                                                    <td class="text-center">
                                                        Rp.{{ number_format($rcv->grand_total,2,',','.') }}
                                                    </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="row">
                            <div class="mx-auto col-9 text-center d-flex justify-content-between">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="small mt-10">{{ $rcv->Pegawai->nama_pegawai }}</div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="small mb-0">Barang akan kami kembalikan apabila terdapat kecacatan saat penerimaan
                                    <br>~ Accounts/Finance dept. copy
                                    <br>~ Supplier copy
                                    <br>~ Inventory/Gudang dept. copy
                                    <br>
