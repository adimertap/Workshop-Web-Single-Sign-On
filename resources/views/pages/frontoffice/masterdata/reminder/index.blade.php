...
<main>
            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">List data reminder untuk pelanggan</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-bordered table-hover dataTable" id="dataTable" width="100%"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 20px;">Nama Reminder</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 20px;">Masa Berlaku</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 20px;">KM Berlaku</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $item->nama_reminder }}</td>
                                            <td>{{ $item->masa_berlaku }}</td>
                                            <td>{{ $item->km_berlaku }}</td>
                                            <td>
                                                <a href="" class="btn btn-primary btn-datatable  mr-2" type="button"
                                                    data-toggle="modal" data-target="#Modaledit-{{ $item->id_master_reminder }}">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="" class="btn btn-danger btn-datatable  mr-2" type="button"
                                                    data-toggle="modal" data-target="#Modalhapus-{{ $item->id_master_reminder }}">
                ...
                <form action="{{ route('reminder.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            @error('nama_reminder')<div class="text-danger small mb-1">{{ $message }}
                            </div> @enderror
                        </div>
                        <div class="form-group">
    ...
    {{-- MODAL EDIT --}}
    @forelse ($reminder as $item)
    <div class="modal fade" id="Modaledit-{{ $item->id_master_reminder }}" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Data Reminder</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">×</span></button>
                </div>
                <form action="#" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="nama_reminder" type="text" id="nama_reminder"
                                placeholder="Input Nama Reminder" value="{{ $item->nama_reminder }}"
                                class="form-control @error('nama_reminder') is-invalid @enderror">
                            @error('nama_reminder')<div class="text-danger small mb-1">{{ $message }}
                            </div> @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input class="form-control" name="masa_berlaku" type="text" id="masa_berlaku"
                                placeholder="Input Masa Berlaku" value="{{ $item->masa_berlaku }}"
                                class="form-control @error('masa_berlaku') is-invalid @enderror">
                            @error('masa_berlaku')<div class="text-danger small mb-1">{{ $message }}
                            </div> @enderror
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="km_berlaku">KM Berlaku</label>
                            <input class="form-control" name="km_berlaku" type="text" id="km_berlaku"
                                placeholder="Input KM Berlaku" value="{{ $item->km_berlaku }}"
                                class="form-control @error('km_berlaku') is-invalid @enderror">
                            @error('km_berlaku')<div class="text-danger small mb-1">{{ $message }}
                            </div> @enderror
                        </div>
    ...
    {{-- MODAL DELETE --}}
    @forelse ($reminder as $item)
    <div class="modal fade" id="Modalhapus-{{ $item->id_master_reminder }}" tabindex="-1" role="dialog"
