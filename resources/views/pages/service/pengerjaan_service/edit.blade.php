                ...
                <form action="{{ route('penerimaanservice.store') }}" id="form1" method="POST"
                    ...
                    <div class="form-row">
                        <div class="form-group col-4">
                            ...
                            <input class="form-control" id="kode_sa" name="kode_sa" type="text" value="{{ $service_advisor->kode_sa }}"
                                readonly />
                        </div>
                        <div class="form-group col-4">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input class="form-control" id="date" name="date" type="text" value="{{ $service_advisor->date }}"
                                readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-3">
                            ...
                            <div class="input-group input-group-joined">
                                ...
                                <select class="form-control" name="id_customer_bengkel" id="id_customer_bengkel"
                                    ...
                                    <option value="{{ $service_advisor->customer_bengkel->id_customer }}">{{ $service_advisor->customer_bengkel->nama_customer }}</option>
                        ...
                        <div class="form-group col-3">
                            <label for="id_kendaraan">Pilih Kendaraan</label><span class="mr-4 mb-3" style="color: red">*</span>
                            <div class="input-group input-group-joined">
                                <select class="form-control" name="id_kendaraan" id="id_kendaraan"
                                    class="form-control @error('id_kendaraan') is-invalid @enderror">
                                    <option value="{{ $service_advisor->kendaraan->id_kendaraan }}">{{ $service_advisor->kendaraan->nama_kendaraan }}</option>
                        ...
                        <div class="form-group col-3">
                            ...
                            <input type="text" class="form-control" id="odo_meter" name="odo_meter"
                                placeholder="Input Odo Meter" value="{{ $service_advisor->odo_meter }}">
                        </div>
                        <div class="form-group col-3">
                            <label for="plat_kendaraan">No. Plat Kendaraan</label>
                            <input type="text" class="form-control" id="plat_kendaraan" name="plat_kendaraan"
                                placeholder="Input Plat Kendaraan" value="{{ $service_advisor->plat_kendaraan }}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control" id="keluhan_kendaraan" name="keluhan_kendaraan"
                                placeholder="Input Keluhan Kendaraan" value="{{ $service_advisor->keluhan_kendaraan }}">
                        </div>
                        <div class="form-group col-4">
                            ...
                            <select class="form-control" name="id_mekanik" id="id_mekanik"
                                ...
                                <option value="{{ $service_advisor->mekanik->id_pegawai }}">{{ $service_advisor->mekanik->nama_pegawai }}</option>
                                @foreach ($mekanik_asli as $gas)
                                <option value="{{ $gas->id_pegawai }}">{{ $gas->nama_pegawai }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control" id="waktu_estimasi" name="waktu_estimasi"
                                placeholder="Input Waktu Estimasi" value="{{ $service_advisor->waktu_estimasi }}">
                        </div>
                    </div>
                </form>
            </div>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover dataTable" id="dataPerbaikan"
                                    ...
                                    <tbody id='konfirmasiPerbaikan'>
                                        @forelse ($service_advisor->detail_perbaikan as $item)
                                        <tr id="item-{{ $item->id_jenis_perbaikan }}" role="row" class="odd">
                                            <th scope="row" class="small" class="sorting_1">{{ $loop->iteration}}</th>
                                            <td class="kode_jenis_perbaikan"><span id="{{ $item->id_jenis_perbaikan }}"> {{ $item->kode_jenis_perbaikan }}</span>
                                               </td>
                                            <td class="nama_jenis_perbaikan">
                                                {{ $item->nama_jenis_perbaikan }}</td>
                                            <td class="group_jenis_perbaikan">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover dataTable" id="dataSparepart"
                                    ...
                                    <tbody id='konfirmasi'>
                                        @forelse ($service_advisor->detail_sparepart as $item)
                                        <tr id="sparepart-{{ $item->id_sparepart }}" role="row" class="odd">
                                            <th scope="row" class="small" class="sorting_1">
                                                {{ $loop->iteration}}</th>
                                            <td class="kode_sparepart"><span id={{ $item->id_sparepart }}></span> {{ $item->kode_sparepart }}
                                               </td>
                                            <td class="nama_sparepart">
                                                {{ $item->nama_sparepart }}</td>
                                            <td class="jenis_sparepart">
                                            ...
                                            <td class="stock">Rp {{ number_format($item->pivot->harga,2,',','.') }}</td>
                                            <td class="stock">{{ $item->pivot->jumlah }}</td>
                                            <td class="stock">Rp {{ number_format($item->pivot->total_harga,2,',','.') }}</td>
                                            <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="button"
                        onclick="kirimfrontoffice(event,{{ $sparepart }},{{ $jasa_perbaikan }},{{ $service_advisor->id_service_advisor }})">Ya!Sudah</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function kirimfrontoffice(event, sparepart, jasa_perbaikan, id_service_advisor) {
        ...
        if (dataform3.length == 0) {
            ...
            $.ajax({
                method: 'put',
                url: '/service/pengerjaanservice/'+ id_service_advisor,
                data: data,
                success: function (response) {
                    window.location.href = '/service/pengerjaanservice'
