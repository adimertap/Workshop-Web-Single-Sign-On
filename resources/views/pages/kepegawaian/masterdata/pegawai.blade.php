...
<div class="container-fluid">
    ...
    <div class="modal fade" id="tambahpegawai" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="tambahpegawai" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
            <div class="modal-content">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" id="inputLastName" type="text" placeholder="NIP Pegawai"
                                    readonly>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" id="inputLocation" type="text"
                                    placeholder="No Telephone Pegawai">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" id="inputLocation" type="text"
                                    placeholder="Jumlah Tanggungan Pegawai">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="inputPhone" type="tel"
                                    placeholder="Pendidikan Terakhir Pegawai">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer"><button class="btn btn-secondary" type="button"
                        data-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Tambah</button>
                </div>
            </div>
        </div>
        </main>
