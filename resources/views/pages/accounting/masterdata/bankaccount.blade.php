                                ...
                                <table class="table table-bordered table-hover dataTable" id="dataTable" width="100%"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Position: activate to sort column ascending"
                                                style="width: 120px;">Alamat Account</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
...
{{-- MODAL EDIT -------------------------------------------------------------------------------------------}}
@forelse ($bankaccount as $item)
<div class="modal fade" id="Modaledit-{{ $item->id_bank_account }}" data-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
...
<div class="modal fade" id="Modalhapus-{{ $item->id_bank_account }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('bank-account.destroy', $item->id_bank_account) }}" method="POST" class="d-inline">
                @csrf
                @method('delete')
