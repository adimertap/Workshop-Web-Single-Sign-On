            ...
            <!-- Illustrations -->
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 13rem;" src="/backend/src/assets/img/ilustrasi/inventoryilustration.jpg" alt="">
                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 13rem;" src="/backend/src/assets/img/ilustrasi/logistic.jpg" alt="">
                    </div>
                        <h2 class="m-0 font-weight-bold text-primary" style="text-align: center">Selamat Datang, I Putu Adi Merta Pratama</h2><p></p>
                        <p style="text-align: center">Add some quality, svg illustrations to your project courtesy of <a target="_blank" rel="nofollow" href="https://undraw.co/">unDraw</a>, a constantly updated collection of beautiful svg images that you can use completely free and without attribution!</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="d-flex align-items-center flex-shrink-0 mr-3">
                                <div class="avatar avatar-xl mr-3 bg-gray-200"><img class="avatar-img img-fluid" src="/backend/src/assets/img/freepik/profiles/profile-6.png" alt=""></div>
                            ...
                            <div class="dropdown no-caret">
                                <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople1" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></button>
                                <div class="dropdown-menu dropdown-menu-right animated--fade-in-up" aria-labelledby="dropdownPeople1" style="">
                                    <a class="dropdown-item" href="https://themes.startbootstrap.com/sb-admin-pro/dashboard-2.html#!">Lihat Profile</a>
                                    <a class="dropdown-item" href="https://themes.startbootstrap.com/sb-admin-pro/dashboard-2.html#!">Edit Profile</a>
                                </div>
                            </div>
                        </div>
