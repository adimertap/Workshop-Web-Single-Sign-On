                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control form-control-sm" id="approve_po" type="text"
                                name="approve_po" value="{{ $po->approve_po }}"
                                readonly />
                        </div>
                        <div class="form-group col-md-6">
            ...
            <div class="card mb-4">
                <div class="card card-header-actions">
                    <div class="card-header ">List Sparepart
                        <a href="{{ route('purchase-order.edit',$po->id_po) }}" class="btn btn-sm btn-primary "> Edit Data Pembelian</a>
                    </div>
                </div>
                <div class="card-body">
